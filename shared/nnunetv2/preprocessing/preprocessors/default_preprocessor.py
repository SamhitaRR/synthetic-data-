...
class DefaultPreprocessor(object):
    ...
    def run_case_npy(self, data: np.ndarray, seg: Union[np.ndarray, None], properties: dict,
        ...
        #tf.imwrite("/media/elstore/users/samhita/timelapse/16092025/nnunet/inference/dataset015_output/normalised.tif", data)
        #print('current shape', data.shape[1:], 'current_spacing', original_spacing,
             ## '\ntarget shape', new_shape, 'target_spacing', target_spacing)
        old_shape = data.shape[1:]
        data = configuration_manager.resampling_fn_data(data, new_shape, original_spacing, target_spacing)
        #tf.imwrite("/media/elstore/users/samhita/timelapse/16092025/nnunet/inference/dataset015_output/normalised2.tif", data)
